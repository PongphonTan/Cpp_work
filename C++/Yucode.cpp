...
void unifDist()
{
	...
	uniform_int_distribution<int> unif(0,19);
	for (int i=0; i<30; ++i)
	{
		cout << unif(re) << "\t";
	}
...
int main()
{
    ...
    int q = 25, co = 0, cs = 0, oo = 0, oa, nc = 0, rq = 0;
    int i=0,n[30],y[30],np[30];
...
int purchase(int n[],int y[], int i) {
  int np[30]={0},v1=0,v2=0,v3=0,np1[30]={0},np2[30]={0},np3[30]={0};
  //y[i]=cus(n,i,y);
